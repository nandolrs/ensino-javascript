// agora que conheçemos estruturas como matrizes e objetos
// precisamos de formas de ler estas estruturas
...
// podemos percorrer a matriz utilizando foreach


debugger;

matrizPersonalidades.forEach( (personalidade) => {

    debugger;
    
    nome = personalidade.nome
    nascimento = personalidade.nascimento
    descricao = personalidade.descricao
    idade = personalidade.idade
